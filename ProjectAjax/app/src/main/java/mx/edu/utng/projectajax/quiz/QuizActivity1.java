        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked()||rdb.isChecked() || rdc.isChecked()
                    ...
                    Toast.makeText(QuizActivity1.this, "No haz respondido",Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    Toast.makeText(QuizActivity1.this, "Tu resultado es: " + calif, Toast.LENGTH_SHORT).

                            show();

                    dbCalif.actualizarDatos(1, String.valueOf(calif));
                    dbCalif.cerrar();
                }
            }

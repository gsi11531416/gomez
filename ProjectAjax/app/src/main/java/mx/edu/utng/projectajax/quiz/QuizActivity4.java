...
public class QuizActivity4 extends Activity {
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked()||rdb.isChecked() || rdc.isChecked()
                    ...
                    Toast.makeText(QuizActivity4.this, "No haz respondido",Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if (qid < 40) {
                        ...
                        Intent intent = new Intent(QuizActivity4.this, ResultActivity.class);
                        Bundle b = new Bundle();
                    ...
                    Toast.makeText(QuizActivity4.this, "Tu resultado es: " + calif, Toast.LENGTH_SHORT).

                            show();

                    dbCalif.actualizarDatos(4, String.valueOf(calif));
                    dbCalif.cerrar();
                }
            }
        });

...
public class QuizActivity5 extends Activity {
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked()||rdb.isChecked() || rdc.isChecked()
                    ...
                    Toast.makeText(QuizActivity5.this, "No haz respondido",Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if (qid < 50) {
                        ...
                        Intent intent = new Intent(QuizActivity5.this, ResultActivity.class);
                        Bundle b = new Bundle();
                    ...
                    Toast.makeText(QuizActivity5.this, "Tu resultado es: " + calif, Toast.LENGTH_SHORT).

                            show();

                    dbCalif.actualizarDatos(5, String.valueOf(calif));
                    dbCalif.cerrar();
                }
            }
        });

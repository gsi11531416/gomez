...
public class QuizActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final DbHelper1 db=new DbHelper1(this);
		...
		butNext.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!(rda.isChecked()||rdb.isChecked() || rdc.isChecked()
					...
					Toast.makeText(QuizActivity.this, "No haz respondido",Toast.LENGTH_SHORT).show();
				}
				else {
					...
					grp.clearCheck();
					int calif = (score * 100 / 20);
					Toast.makeText(QuizActivity.this, "Tu resultado es: " + calif, Toast.LENGTH_SHORT).

							show();

					dbCalif.actualizarDatos(6, String.valueOf(calif));
					dbCalif.cerrar();
				}
			}
		});

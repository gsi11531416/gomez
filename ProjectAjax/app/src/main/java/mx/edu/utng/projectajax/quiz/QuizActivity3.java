        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked()||rdb.isChecked() || rdc.isChecked()
                    ...
                    Toast.makeText(QuizActivity3.this, "No haz respondido",Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if (qid < 30) {
                        ...
                        Intent intent = new Intent(QuizActivity3.this, ResultActivity.class);
                        Bundle b = new Bundle();
                    ...
                    Toast.makeText(QuizActivity3.this, "Tu resultado es: " + calif, Toast.LENGTH_SHORT).

                            show();

                    dbCalif.actualizarDatos(3, String.valueOf(calif));
                    dbCalif.cerrar();
                }
            }
        });
